      ...
      <div className="max-w-2xl mx-auto px-4">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400">Recevez les événements AgentFlow dans votre propre système</p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-6 mb-6">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 mb-4">
            AgentFlow enverra un POST JSON à cette URL après chaque exécution d&apos;agent ou traitement d&apos;email.
          </p>
